...
public static void main(String[] args){
	...
	System.out.println("Balance after $2500 withdraw " +       account1.getAnnualInterestRate());
	System.out.println("Balance after $3000 deposit " + account1.getAnnualInterestRate());
